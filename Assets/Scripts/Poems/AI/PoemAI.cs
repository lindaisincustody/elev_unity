...
public class PoemAI : MonoBehaviour
{
    ...
    private string prompt = "Please add 4 lines to this poem, ensuring that each line does not begin with the same word as the preceding line, and each line should not exceed 6 words in length. Your added version should be very abstract, not focusing on one emotion. The poem is: ";
